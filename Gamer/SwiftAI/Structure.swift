...
extension NeuralNet {
    ...
    struct Structure {
        ...
        let hiddenActivation: ActivationFunction.Hidden
        
        /// The activation function to apply to the output layer during inference.
        let outputActivation: ActivationFunction.Output
        ...
        init(nodes: [Int], hiddenActivation: ActivationFunction.Hidden, outputActivation: ActivationFunction.Output,
