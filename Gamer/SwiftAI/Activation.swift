...
extension NeuralNet {
    ...
    enum ActivationFunction {
        ...
        enum Hidden {
            ...
            func computeActivation(_ x: [Float], result: inout [Float], rows: Int, cols: Int) {
                switch self {
                case .linear:
                    result = x
                case .rectifiedLinear:
            ...
            ///   - rows: The number of rows in the matrix (the number of sets in the batch).
            ///   - cols: The number of columns in the matrix (the number of inputs in each input set).
            func calculateDerivative(_ y: [Float], result: inout [Float], rows: Int, cols: Int) {
                switch self {
                case .linear:
                    for i in 0..<(rows * cols) {
                        result[i] = 1
        ...
        enum Output {
            ...
            ///   - rows: The number of rows in the matrix (number of output sets in the batch).
            ///   - cols: The number of columns in the matrix (number of outputs per set).
            func calculateErrorGradient(real: [Float], target: [Float], result: inout [Float], rows: Int, cols: Int) {
                switch self {
                case .linear:
                    // TODO
                    break
